      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 text-white">
        <div className="grid lg:grid-cols-2 gap-4 xs:gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <motion.h2 
              className="text-2xs xs:text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-red-400 font-semibold"
              variants={fadeInUp}
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-3 xs:px-4 sm:px-5 md:px-6 py-1 xs:py-1.5 sm:py-2 bg-gradient-to-r from-red-500 to-red-600 rounded-full font-semibold hover:shadow-xl transition-all duration-300 text-3xs xs:text-2xs sm:text-xs md:text-sm"
              >
                {slides[currentSlide].buttonText}
              </motion.a>
              
              <motion.a
                href="tel:+9718921229 / 9548829492"
                whileHover={{ 
                  scale: 1.05,
                ...
                whileTap={{ scale: 0.95 }}
                className="px-3 xs:px-4 sm:px-5 md:px-6 py-1 xs:py-1.5 sm:py-2 border-2 border-white rounded-full font-semibold hover:bg-white/10 transition-all duration-300 text-3xs xs:text-2xs sm:text-xs md:text-sm"
              >
                Call Now
              </motion.a>
            </motion.div>
          ...
          {/* Right Content - Statistics Cards - Hidden on mobile/tablet */}
          <motion.div 
            className="hidden lg:grid lg:grid-cols-1 gap-6 mt-0"
            variants={fadeInUp}
            initial="initial"
            animate="animate"
