      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-red-600 to-blue-600 rounded-lg flex items-center justify-center text-white group-hover:shadow-lg transition-all duration-300">
                      {info.icon}
                    </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="w-full bg-gradient-to-r from-red-600 to-blue-600 text-white font-semibold py-4 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                whileHover={{ 
                  scale: 1.05,
        ...
        >
          <div className="bg-gradient-to-r from-red-600 to-blue-600 rounded-2xl p-8 text-white">
            ...
            <motion.a
              href="tel:9718921229"
              className="inline-flex items-center gap-2 bg-white text-red-600 font-semibold py-3 px-6 rounded-lg hover:bg-gray-100 transition-all duration-300"
