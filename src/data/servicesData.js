...
export { CEILING_SERVICES };

// Helper function to get all services
export const getAllServices = () => {
  return CEILING_SERVICES;
};

// Helper function to get service by slug
export const getServiceBySlug = (slug) => {
  return CEILING_SERVICES.find(service => service.slug === slug) || null;
};

// Helper function to get related services (excluding current service)
export const getRelatedServices = (currentSlug) => {
  return CEILING_SERVICES
    .filter(service => service.slug !== currentSlug)
    .slice(0, 3); // Return only 3 related services
};
